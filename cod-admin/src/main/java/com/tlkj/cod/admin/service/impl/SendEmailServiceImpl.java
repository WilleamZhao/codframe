...
import com.tlkj.cod.admin.service.SendEmailService;
...
public class SendEmailServiceImpl implements SendEmailService {
     ...
     */
    @Override
    public boolean sendEmail(String toEmailAddress, String emailTitle, String emailContent) {
        ...
        try {
            ...
            msg.setFrom(new InternetAddress(myEmailAccount,"测试发送人", "UTF-8"));
            //得到邮差对象
