...
package com.tlkj.cod.cache.redis.service.impl;
...
/**
 * Desc codFrame Redis缓存实现
 *
 * @author sourcod
 * @version 1.0
 * @className CodCacheRedisServiceImpl
 * @date 2019/2/13 10:47 AM
 */
@Service("codCacheRedis")
public class CodCacheRedisServiceImpl implements CodCacheRedisService, CodCacheManager {
    ...
    private CodCacheRedisServiceImpl() {
    ...
    private static final CodCacheRedisServiceImpl jedisUtil = new CodCacheRedisServiceImpl();
     ...
     * @return
     */
    public static CodCacheRedisServiceImpl getInstance() {
        return jedisUtil;
    }
    ...
    public static void main(String[] args) {
        CodCacheRedisServiceImpl jedisUtil= CodCacheRedisServiceImpl.getInstance();
        CodCacheRedisServiceImpl.Strings strings=jedisUtil.new Strings();
        strings.set("nnn", "nnnn");
        System.out.println("-----"+strings.get("nnn"));

        Jedis jedis = CodCacheRedisServiceImpl.getInstance().getJedis();
        for (int i = 0; i < 10; i++) {
            jedis.set("test", "test");
            System.out.println(i+"=="+jedis.get("test"));

        }
        CodCacheRedisServiceImpl.getInstance().returnJedis(jedis);
    }
}
