 ...
 */
@RestController
@RequestMapping(value = "gwgz/collect")
public class GwgzCollectApi extends GeneralResponse {
    ...
    public Response list(HttpServletRequest request) {
        ...
        String page = request.getParameter("openid");
        String pageSize = request.getParameter("openid");
        gwgzCollectService.list(page, pageSize);
