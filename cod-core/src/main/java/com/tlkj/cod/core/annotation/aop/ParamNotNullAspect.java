...
public class ParamNotNullAspect extends GeneralResponse{
	 ...
	 * @throws Throwable
	 */
	@Around("@annotation(com.tlkj.cod.core.annotation.ParamNotNull) && @annotation(paramNotNull) && !execution(int *.* (..)) && execution(* com.tlkj.cod.service..* (..))")
	public Object advice1(ProceedingJoinPoint joinPoint, ParamNotNull paramNotNull) throws Throwable{
		String[] paraName = paramNotNull.parameter().split(",");
