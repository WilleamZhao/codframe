...
public class CodServerTomcatImpl implements CodServer {

    private static Tomcat tomcat = null;
    private static Logger logger = LoggerFactory.getLogger(CodServerTomcatImpl.class);
    ...
    public void start(LauncherModel launcherModel) {
        ...
        // 设置服务信息
        // setServerInfo();
        CodServerTomcatModel codServerModel = (CodServerTomcatModel) this.launcherModel.getServer();
        ...
        for (FilterModel filterModel : filters){
            ...
            filterDef.setFilterClass(filterModel.getName());
            filterDef.setFilter(filterModel.getFilter());
            Map<String, String> maps = filterModel.getParamList();
            // add params
            ...
            filterMap.setFilterName(filterModel.getName());
            filterMap.addURLPattern(filterModel.getMapping());
            filterMap.setDispatcher(filterModel.getDispatcher().name());
