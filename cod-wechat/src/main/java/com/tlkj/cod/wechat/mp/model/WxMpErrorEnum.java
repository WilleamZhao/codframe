...
package com.tlkj.cod.wechat.mp.model;
 ...
 * @author sourcod
 * @version 1.0
 * @className WxMpErrorEnum
 * @date 2019/3/12 4:01 PM
 */
public enum WxMpErrorEnum {
    /**
     * 系统繁忙，此时请开发者稍候再试
     */
    ...
    CODE_0(0, "请求成功"),
    /**
     * 获取 cod_admin_token 时 AppSecret 错误，或者 cod_admin_token 无效。请开发者认真比对 AppSecret 的正确性，或查看是否正在为恰当的公众号调用接口
     */
    ...
    WxMpErrorEnum(int code, String msg) {
        this.code = code;
        this.msg = msg;
    }
    ...
    public static String findMsgByCode(int code) {
        for (WxMpErrorEnum value : WxMpErrorEnum.values()) {
            if (value.code == code) {
                return value.msg;
            }
        }
